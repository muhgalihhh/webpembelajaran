<div x-data="{ show: false }" x-show="show" x-on:open-modal.window="show = true" x-on:close-modal.window="show = false"
    x-on:keydown.escape.window="show = false" x-on:click.self="show = false"
    class="fixed inset-0 z-50 flex items-center justify-center">
    <div x-on:click="show = false" class="fixed inset-0 bg-black bg-opacity-50 transition-opacity"></div>
