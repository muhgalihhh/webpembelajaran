<x-ui.auth-card>
    ...
    <div class="relative overflow-visible">
        <form wire:submit.prevent="register">
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <x-form.input-group type="email" id="reg_email" placeholder="Masukkan Email"
                        wireModel="email" icon="fa-solid fa-envelope" required />
    ...
    wireModel="gender"
    :options="[
        ['id' => 'L', 'class' => 'Laki-laki'],
        ['id' => 'P', 'class' => 'Perempuan'],
    ]"
    optionLabel="class"
    optionValue="id"
    required
/>
            ...
            <div class="mt-4 text-sm text-center text-gray-600">
                ...
                <a href="{{ route('login') }}" class="font-bold text-blue-600 hover:underline"
                    wire:navigate>Masuk Sekarang!</a>
            </div>
        </form>
    </div>
